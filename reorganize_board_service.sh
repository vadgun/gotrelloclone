...
echo "📦 Reorganizando estructura del board-service..."

SERVICE_DIR="./board-service"
...
if command -v git &> /dev/null; then
  ...
  git mv $SERVICE_DIR/config/board_config.go $INFRA_DIR/config/config.go
  ...
  mv $SERVICE_DIR/config/board_config.go $INFRA_DIR/config/config.go
...
echo "✅ board-service reorganizado con la carpeta infra 🚀"
